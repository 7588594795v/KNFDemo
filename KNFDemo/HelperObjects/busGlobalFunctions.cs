...
namespace KNFDemo.Helpers
{
    public static class busGlobalFunctions
    {
        ...
        //{
        //    string lstrAccountSid = busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.Common.Twilio.CONFIG_TWILIO_ACCOUNT_SID);
        //    string lstrAuthToken = busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.Common.Twilio.CONFIG_TWILIO_AUTH_TOKEN);
        //    string lstrFromPhone = busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.Common.Twilio.CONFIG_TWILIO_FROM_PHONE_NO);
        ...
        {
            GetFiscalYearRangeForGivenDate(busGlobalFunctions.ApplicationDateTime().Date, ref adtFiscalYearStart, ref adtFiscalYearEnd);
        }
        ...
        {
            DateTime ldtDate = new DateTime(aintYear - 1, busConstant.FISCAL_YEAR_START_MONTH, busConstant.FISCAL_YEAR_START_DATE);
        ...
        public static void GetFiscalYearRangeForGivenDate(DateTime adtGivenDate, ref DateTime adtFiscalYearStart, ref DateTime adtFiscalYearEnd)
        {
            ...
            if (adtGivenDate.Month > busConstant.FISCAL_YEAR_END_MONTH)
            {
                adtFiscalYearStart = new DateTime(adtGivenDate.Year, busConstant.FISCAL_YEAR_START_MONTH, busConstant.FISCAL_YEAR_START_DATE);
                adtFiscalYearEnd = new DateTime(adtGivenDate.Year + 1, busConstant.FISCAL_YEAR_END_MONTH, busConstant.FISCAL_YEAR_END_DATE);
            }
            else
            {
                adtFiscalYearStart = new DateTime(adtGivenDate.Year - 1, busConstant.FISCAL_YEAR_START_MONTH, busConstant.FISCAL_YEAR_START_DATE);
                adtFiscalYearEnd = new DateTime(adtGivenDate.Year, busConstant.FISCAL_YEAR_END_MONTH, busConstant.FISCAL_YEAR_END_DATE);
            }
        }
        ...
        //{
        //    string lstrSmtpServer = busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.SMTPSetting.SMTP_HOST_PATH);
        //    string lstrUserName = busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.SMTPSetting.SMTP_USERNAME);
        //    string lstrPassword = busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.SMTPSetting.SMTP_PASSWORD);
        //    int lintPort = Convert.ToInt32(busGlobalFunctions.GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.SMTPSetting.SMTP_HOST_PORT));
        ...
        //            string lstrSmtpServer = busGlobalFunctions.GetAppConfigValue(autlPassInfo, busConstant.SMTPSetting.SMTP_HOST_PATH);
        //            string lstrUserName = busGlobalFunctions.GetAppConfigValue(autlPassInfo, busConstant.SMTPSetting.SMTP_USERNAME);
        //            string lstrPassword = busGlobalFunctions.GetAppConfigValue(autlPassInfo, busConstant.SMTPSetting.SMTP_PASSWORD);
        ...
        //                msg.Headers.Add(busConstant.Communication.RECIPIENT_COR_TRACKING_ID, aintRecipientID.ToString());
        ...
        //    {
        //        if (lbusJobSchedule.icdoJobSchedule.active_flag == busConstant.FLAG_YES)
        //        {
        ...
        public static int DateDiff(enmDateInterval aenmInterval, DateTime adtFirstDate, DateTime adtSecondDate)
        {
            ...
            switch (aenmInterval)
            {
                ...
                case enmDateInterval.Month:
                    ...
                    {
                        lintDifference = (ldtGreaterDate.Year - ldtLesserDate.Year) * busConstant.MONTHS_IN_YEAR + (ldtGreaterDate.Month - ldtLesserDate.Month) + 1;
                    }
                    else
                    {
                        lintDifference = (ldtGreaterDate.Year - ldtLesserDate.Year) * busConstant.MONTHS_IN_YEAR + (ldtGreaterDate.Month - ldtLesserDate.Month);
                    }
                    break;
        ...
        //{
        //    string lstrSenderEmailAddress = autlPassInfo.isrvDBCache.GetConstantValue(busConstant.Common.Codes.SystemConstantsAndVariables.SENDER_EMAIL_ADDRESS).ToString();
        //    return busGlobalFunctions.SendMail(lstrSenderEmailAddress, astrRecipientEmailAddress, astrSubjectLine, astrBody, aenmEncoding, ablnIsBodyHtml, acolAttachments, autlPassInfo, aintRecipientID);
        //}
        ...
        //            if (iobjPassInfo.isrvDBCache.GetConstantValue(busConstant.Common.Codes.SystemConstantsAndVariables.SYSTEM_CONSTANT_USE_SYSTEM_EMAIL) == busConstant.FLAG_YES)
        //            {
        //                SendEmailAsync(iobjPassInfo.isrvDBCache.GetConstantValue(busConstant.Common.Codes.SystemConstantsAndVariables.SYSTEM_CONSTANT_RECIPIENT_PERSONAL_EMAIL), lstrSubjectLine, lstrMessage, System.Text.Encoding.UTF8, false, null, utlPassInfo.iobjPassInfo);
        //            }
        ...
        //                  string lstrSubjectLine = string.Format(lstrSubjectLineTemplate, lbusJobSchedule.icdoJobSchedule.schedule_name);
        //                  string lstrMessage = string.Format(lstrMessageTemplate, lbusJobSchedule.icdoJobSchedule.schedule_name, busGlobalFunctions.ApplicationDateTime.ToString());

        //                  //PIR 466 : 
        //                  //if (aintProcessedRecordCount > 0)
        //                  //{
        //                  lstrMessage = string.Format(lstrMessageTemplate + " " + lstrRecordCountTemplate, lbusJobSchedule.icdoJobSchedule.schedule_name, busGlobalFunctions.ApplicationDateTime.ToString(), aintProcessedRecordCount.ToString());
        //                  //}
        ...
        //            string lstrMessage = string.Format(lstrMessageTemplate, lbusFile.icdoFile.description, acdoFileHdr.processed_file_name, busGlobalFunctions.ApplicationDateTime.ToString(), acdoFileHdr.status_description);
        ...
        //{
        //    string lstrKeyUserId = GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.GNUPgpSetting.GNUPGP_KEY_USER_ID);
        //    string lstrAppPath = GetAppConfigValue(utlPassInfo.iobjPassInfo, busConstant.GNUPgpSetting.GNUPGP_APP_PATH);
        ...
        //{
        //    string lstrAppPath = HelperFunction.GetAppSettings(busConstant.GNUPgpSetting.GNUPGP_APP_PATH);
        ...
        //{
        //    if (HelperUtil.GetData1ByCodeValue(busConstant.Common.Codes.SystemConstantsAndVariables.SYSTEM_CONSTANTS_AND_VARIABLES_CODE_ID, busConstant.Common.Codes.SystemConstantsAndVariables.AES_ENCRYPTION_FLAG) != busConstant.FLAG_YES)
        //    {
        ...
        //    DataTable ldtbList = lbusMainbase.iobjPassInfo.isrvDBCache.GetCacheData(busConstant.SGS_CODE_VALUE, string.Format(busConstant.CODE_ID_AND_VALUE_EQUALS, aintCodeId, astrCodeValue));
        ...
        //    busMainBase lbusMainbase = new busMainBase();
        //    //DataTable ldtbList = lbusMainbase.iobjPassInfo.isrvDBCache.GetCodeValues(aintCodeId);
        //    DataTable ldtbList = lbusMainbase.iobjPassInfo.isrvDBCache.GetCacheData(busConstant.SGS_CODE_VALUE_DATA, string.Format(busConstant.CODE_ID_AND_VALUE_EQUALS, aintCodeId, astrCodeValue));
        ...
        //        //DataTable ldtbList1 = lbusMainbase.iobjPassInfo.isrvDBCache.GetCacheData(busConstant.SGS_CODE_VALUE_DATA, string.Format(busConstant.CODE_SERIAL_ID_EQUALS, lbusCodeValue.icdoCodeValue.code_serial_id));
        ...
        //    Stream lstmStream = new MemoryStream(GetAssociatedFile(utlPassInfo.iobjPassInfo, busConstant.SFTPServerSettings.SFTP_SERVER_KEY_FILE));
        ...
        //                                         new object[2] { iobjPassInfo.iintUserSerialID, busConstant.RESOURCE_ID_PAYMENT_ADMINISTRATOR },
        ...
        {
            return adtDateOfBirth.AgeInYearsAsOfDate(busGlobalFunctions.ApplicationDateTime().Date);
        }
